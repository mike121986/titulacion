	...
	<div class="container">
		<form action="<?=base_url?>Categoria/update" method="POST">
			<div class="form-group">
				...
				<input type="hidden" name="idCategoria" id="categoriaHidden" value="<?=$editarProducto->id?>">
			...
			<div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
				...
				<div class="btn-group mr-2" role="group" aria-label="Second group">
					<button class="btn btn-danger" id="deleteCategoria">ELIMINAR  
					<span id="charge" class="" role="status" aria-hidden="true"></span>
					</button>
				</div>
				<div class="btn-group mr-2" role="group" aria-label="Second group">
